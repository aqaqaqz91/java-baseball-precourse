...
public class Const {
    ...
    public static final String GAME_CLEAR_MSG = Rule.COUNT+"개의 숫자를 모두 맞히셨습니다! 게임 종료";
    ...
    public static final String INVALID_USER_INPUT_RANGE =
            INVALID_USER_INPUT+"(["+Rule.MIN_NUM+"~"+Rule.MAX_NUM+"]이외는 허용되지 않습니다.)";

    public static final String INVALID_USER_INPUT_RESTART =
            INVALID_USER_INPUT+"(["+RESTART+","+END+"]이외는 허용되지 않습니다.)";
}
